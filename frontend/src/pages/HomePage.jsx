      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-20 md:py-28 relative">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-forest-800/60 border border-forest-600/40 text-forest-300 text-xs font-semibold px-4 py-1.5 rounded-full mb-6 backdrop-blur-sm">
              <span className="w-2 h-2 bg-forest-400 rounded-full animate-pulse" />
              AI-Powered Botanical Research
            </div>
          
            {/* <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-6">
              Predict Plant
              <br />
              <span className="text-forest-400">Hybrids</span> with AI
            </h1> */}
            ...
            {/* <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/predict" className="btn-primary text-base text-center py-4 px-8 shadow-lg shadow-forest-900/40">
                🌱 Start Prediction
              </Link>
              <Link to="/history" className="btn-secondary text-base text-center py-4 px-8 bg-white/10 border-white/20 text-white hover:bg-white/20">
                View History
              </Link>
            </div> */}
          </div>
