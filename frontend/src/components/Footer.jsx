...
//               An intelligent hybrid plant prediction system powered by machine learning and botanical science.
//             </p>
//           </div>
...
//               {[['/', 'Home'], ['/predict', 'Plant Selection'], ['/history', 'Prediction History']].map(([to, label]) => (
//                 <li key={to}>
//                   <Link to={to} className="text-sm text-sage-400 hover:text-forest-400 transition-colors duration-150">
//                     {label}
//                   </Link>
//                 </li>
//               ))}
...
//           {/* Credits */}
//           <div>
//             <h4 className="text-white font-semibold text-sm uppercase tracking-wider mb-4">Project Credits</h4>
//             <ul className="space-y-2 text-sm text-sage-500">
//               <li>Built with React + Vite</li>
//               <li>Styled with Tailwind CSS</li>
//               <li>API via Node.js + Express</li>
//               <li>Data stored in MongoDB</li>
//             </ul>
//           </div>
//         </div>

//         <div className="border-t border-sage-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-3">
//           <p className="text-xs text-sage-600">
//             © {new Date().getFullYear()} HybridFlora Prediction System. All rights reserved.
//           </p>
//           <p className="text-xs text-sage-600">
//             Advancing botanical science through AI
//           </p>
//         </div>
//       </div>
//     </footer>
