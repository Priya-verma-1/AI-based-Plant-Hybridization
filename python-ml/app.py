# app.py
# ─────────────────────────────────────────────────────────────────────────────
# Flask REST API for the Hybrid Plant ML service.
#
# Endpoints:
#   POST /predict          → run ML inference on a plant pair
#   POST /train            → retrain all models (async-safe, returns immediately)
#   GET  /health           → service health + model status
#   GET  /report           → last training metrics report
#   GET  /                 → API info
# ─────────────────────────────────────────────────────────────────────────────
