...
// // // Pure helper functions for parsing plant data, computing hybrid traits,
// // // and formatting API responses. No side effects, easy to unit-test.
...
// //  */
// // const round = (num, dp = 0) => Math.round(num * 10 ** dp) / 10 ** dp

// // /**
// //  * Compute the arithmetic mean of two numeric values.
// //  */
// // const avgNum = (a, b) => round((a + b) / 2)

// // /**
// //  * For categorical traits, pick one of the parents' values or mark as
// //  * 'Intermediate' when both differ.
// //  *
// //  * Rules:
// //  *   - Same value      → keep that value
// //  *   - Different values → 'Intermediate' (or custom resolver)
// //  */
// // const blendCategorical = (valA, valB, resolver = null) => {
// //   if (valA === valB) return valA
// //   if (resolver) return resolver(valA, valB)
// //   return 'Intermediate'
// // }

// // /**
// //  * Resistance ranking for hybrid computation.
// //  * Hybrid inherits the HIGHER resistance (dominant trait model).
// //  */
// // const RESISTANCE_RANK = { Low: 1, Moderate: 2, High: 3, 'Very High': 4 }
// // const RESISTANCE_BY_RANK = Object.fromEntries(
// //   Object.entries(RESISTANCE_RANK).map(([k, v]) => [v, k])
// // )

// // const blendResistance = (a, b) => {
// //   const rankA = RESISTANCE_RANK[a] ?? 2
// //   const rankB = RESISTANCE_RANK[b] ?? 2
// //   // Heterosis: hybrid often exceeds lower parent
// //   const hybridRank = Math.min(Math.max(rankA, rankB) + (rankA !== rankB ? 0 : 0), 4)
// //   return RESISTANCE_BY_RANK[hybridRank] ?? 'Moderate'
// // }

// // /**
// //  * Yield level ranking for hybrid computation.
// //  * Hybrid inherits the AVERAGE yield, rounded up.
// //  */
// // const YIELD_RANK = { Low: 1, Moderate: 2, Medium: 2, High: 3, 'Very High': 4 }
// // const YIELD_BY_RANK = { 1: 'Low', 2: 'Moderate', 3: 'High', 4: 'Very High' }

// // const blendYield = (a, b) => {
// //   const rankA = YIELD_RANK[a] ?? 2
// //   const rankB = YIELD_RANK[b] ?? 2
// //   const hybridRank = Math.ceil((rankA + rankB) / 2)
// //   return YIELD_BY_RANK[Math.min(hybridRank + (rankA !== rankB ? 1 : 0), 4)] ?? 'Moderate'
// // }

// // /**
// //  * Rule-based hybrid trait computation.
// //  * Used as a fallback when the ML API is unavailable.
// //  *
// //  * @param {Object} plantA - Mongoose Plant document (or plain object)
// //  * @param {Object} plantB - Mongoose Plant document (or plain object)
// //  * @returns {Object} predicted traits
// //  */
// // const computeHybridTraits = (plantA, plantB) => {
// //   return {
// //     height:       avgNum(plantA.height_cm, plantB.height_cm),
// //     leaf_shape:   blendCategorical(plantA.leaf_shape, plantB.leaf_shape),
// //     flower_color: blendCategorical(plantA.flower_color, plantB.flower_color),
// //     climate:      blendCategorical(plantA.climate, plantB.climate),
// //     resistance:   blendResistance(plantA.resistance, plantB.resistance),
// //     growth_days:  avgNum(plantA.growth_days, plantB.growth_days),
// //     yield_level:  blendYield(plantA.yield_level, plantB.yield_level),
// //   }
// // }

// // /**
// //  * Derive a hybrid display name from two parent names.
// //  * Tries to find a common genus prefix, otherwise concatenates.
// //  */
// // const deriveHybridName = (nameA, nameB) => {
// //   const wordsA = nameA.split(' ')
// //   const wordsB = nameB.split(' ')
// //   if (wordsA[0] === wordsB[0]) {
// //     return `${wordsA[0]} × hybrid`
// //   }
// //   return `${nameA} × ${nameB} hybrid`
// // }

// // /**
// //  * Normalise a prediction response from the ML API into our standard shape.
// //  * Handles variance in ML response key names.
// //  */
// // const normaliseMlResponse = (mlData) => {
// //   // ML might return snake_case or camelCase keys
// //   const get = (obj, ...keys) => {
...
// //   return {
// //     height:       get(mlData, 'height', 'height_cm'),
// //     leaf_shape:   get(mlData, 'leaf_shape', 'leafShape'),
// //     flower_color: get(mlData, 'flower_color', 'flowerColor'),
// //     climate:      get(mlData, 'climate', 'climate_adaptability', 'climateAdaptability'),
// //     resistance:   get(mlData, 'resistance', 'disease_resistance', 'diseaseResistance'),
// //     growth_days:  get(mlData, 'growth_days', 'growthDuration', 'growth_duration'),
// //     yield_level:  get(mlData, 'yield_level', 'yield', 'yieldLevel'),
// //   }
// // }

// // /**
// //  * Format a Plant document as a clean API-safe object.
// //  */
...
// // /**
// //  * Format a PredictionHistory document as a clean API-safe object.
// //  */
...
// // /**
// //  * Build the standard prediction API response shape.
// //  */
// // const buildPredictionResponse = ({ plantA, plantB, traits, hybridName, source }) => ({
// //   plantA:           plantA,
// //   plantB:           plantB,
...
// /**
//  * Derive a hybrid display name from two parent scientific names.
//  * Shared genus → "Genus × hybrid", otherwise "NameA × NameB hybrid"
//  */
// const deriveHybridName = (nameA, nameB) => {
//   const wordsA = (nameA || '').split(' ')
//   const wordsB = (nameB || '').split(' ')
//   if (wordsA[0] && wordsA[0] === wordsB[0]) {
//     return `${wordsA[0]} × hybrid`
//   }
//   return `${nameA} × ${nameB} hybrid`
// }
